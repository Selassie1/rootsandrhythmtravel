           ...
           await resend.emails.send({
             ...
             html: `
               <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #131A14; color: #FAFAF8; padding: 40px; border-radius: 16px;">
                 ...
                 <p style="color: #ffffff; opacity: 0.8; line-height: 1.6;">Your payment of $${tourValuePaidUSD.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} USD has been successfully received.</p>
