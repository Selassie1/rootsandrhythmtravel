...
export default function VerifyReceiptClient({ transactionData, reference }: ReceiptClientProps) {
  ...
  const downloadPDF = () => {
    setDownloading(true);
    // Explicitly leveraging the native Browser PDF Vector Engine bypassing JS color parsing limits completely
    setTimeout(() => {
       window.print();
       ...
       */}
       ...
       >
          ...
          <div className="relative z-10 flex flex-col gap-6">
             ...
             <div className="grid grid-cols-2 gap-y-6 gap-x-4">
                ...
                <div className="flex flex-col col-span-2 my-2 border-t border-white/5 pt-4 text">
                ...
                <div className="flex flex-col border-t border-white/5 pt-4 mt-2 text-left">
       ...
       <div className="flex items-center gap-4 w-full max-w-2xl px-2 print-hide">
          <button 
             ...
             className="flex-1 bg-[#FAFAF8] text-[#131A14] hover:bg-[#E8D3A2] py-4 rounded-full font-bold uppercase tracking-widest text-[10px] sm:text-xs transition-colors flex items-center justify-center gap-2 group disabled:opacity-50"
          >
