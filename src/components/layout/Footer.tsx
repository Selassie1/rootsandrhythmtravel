        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-24">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-4 flex flex-col items-start lg:pr-12">
             ...
             <div className="flex gap-4">
                {/* Custom Social Icons - SVG format */}
                <a href="#" aria-label="Instagram" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#E8D3A2] hover:text-[#1A241B] hover:border-[#E8D3A2] transition-colors duration-300">
                ...
                <a href="#" aria-label="X (formerly Twitter)" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#E8D3A2] hover:text-[#1A241B] hover:border-[#E8D3A2] transition-colors duration-300">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a href="#" aria-label="Facebook" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#E8D3A2] hover:text-[#1A241B] hover:border-[#E8D3A2] transition-colors duration-300">
