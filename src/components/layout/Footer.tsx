...
const Footer = async () => {
  ...
  const threadsUrl = settings.twitter_url || '#';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-24">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-4 flex flex-col items-start lg:pr-12">
             ...
             <div className="flex gap-4">
                ...
                <a href={threadsUrl} target={threadsUrl !== '#' ? '_blank' : undefined} rel="noopener noreferrer" aria-label="Threads" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#E8D3A2] hover:text-[#1A241B] hover:border-[#E8D3A2] transition-colors duration-300">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/icons/Threadslogo.svg" alt="Threads" className="w-4 h-4 invert opacity-60 group-hover:invert-0 transition-all" />
                </a>
